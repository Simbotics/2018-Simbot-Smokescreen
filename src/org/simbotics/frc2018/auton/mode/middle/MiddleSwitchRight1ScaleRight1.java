...
public class MiddleSwitchRight1ScaleRight1 implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveToPoint(4.5, 8.3, 70.0, 0.25, 10, 0.75, 7, 20.0, false, 5000));
		...
		// get second cube
		ab.addCommand(new DriveToPoint(-0.2, 3.48, 61.3, 0.0, 11, 0.75, 7, true, 5000));
		...
		ab.addCommand(new DriveToPoint(-0.2, 7.0, 90, 0.0, 7, 0.25, 25, true, 5000));
		ab.addCommand(new IntakeAntiJamNoBump(1.0, 150));
		ab.addCommand(new DriveSetOutput(0.0));
		ab.addCommand(new IntakeWait());
		ab.addCommand(new DriveSetOutput(0));

		ab.addCommand(new DriveToPoint(-0.65, 6.13, 180 - 116, 3, 6, 0.25, 25, true, 5000));
		ab.addCommand(new IntakeAntiJamClosed());
		ab.addCommand(new DriveToPoint(8.83, 10.07, 180 - 149, 8, 10, 0.25, 25, true, 5000));
		ab.addCommand(new DriveToPoint(11.16, 17.96, 180 - 90, 8, 10, 1.5, 25, true, 5000));
		ab.addCommand(new DriveToPoint(9.03, 26.88, 180 - 55, 2, 8, 0.25, 25, true, 5000));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		...
		ab.addCommand(new DriveTurnToAngle(180 - 55, 1, 500));
		ab.addCommand(new DriveWait());
