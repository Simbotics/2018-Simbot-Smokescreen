...
public class MiddleSwitchRight4Cubes implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveToPoint(4.5, 8.3, 75.0, 0.25, 10, 0.75, 10, 20.0, false, 5000));
		...
		// get second cube
		ab.addCommand(new DriveToPoint(0.5, 3.48, 61.3, 0.0, 11, 0.75, 7, true, 5000));
		...
		ab.addCommand(new DriveWait());
		ab.addCommand(new DriveTurnToAngle(90, 5, 1000));
		ab.addCommand(new DriveToPoint(0.5, 7.0, 90, 0.0, 7, 0.25, 25, true, 5000));
		...
		// go score 2nd cube
		ab.addCommand(new DriveToPoint(-0.08, 4.75, 48.0, 0.0, 6, 0.4, 25, true, 5000));
		ab.addCommand(new DriveWait());

		ab.addCommand(new DriveToPoint(2.6, 9.4, 62.0, 0.0, 11, 0.75, 25, true, 5000));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		...
		// 3rd cube
		ab.addCommand(new DriveToPoint(3.5, 6.55, 143, 0.0, 9, 0.75, 15, true, 5000));
		ab.addCommand(new AutonWait(500));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		ab.addCommand(new LiftSetPosition(ElevatorPosition.GROUND, WristPosition.LEVEL, 20));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.GROUND, WristPosition.LEVEL));
		ab.addCommand(new DriveToPoint(1.15, 9.13, 143.0, 0.0, 7, 0.75, 15, true, 5000));

		ab.addCommand(new IntakeAntiJamNoBump(1.0, 150));
		ab.addCommand(new IntakeWait());

		ab.addCommand(new DriveToPoint(2.3, 8.0, 130.0, 0.0, 8, 0.75, 15, true, 5000));
		ab.addCommand(new AutonWait(500));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		ab.addCommand(new LiftSetPosition(ElevatorPosition.SWITCH, WristPosition.LEVEL, 0.8, 1000));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.SWITCH, WristPosition.LEVEL));

		ab.addCommand(new DriveToPoint(2.5, 10.5, 70.0, 0.0, 11, 0.75, 15, true, 5000));
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveToPoint(2.4, 7.75, 90.0, 0.0, 5, 0.75, 7, true, 5000));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		ab.addCommand(new LiftSetPosition(ElevatorPosition.GROUND, WristPosition.LEVEL, 20));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.GROUND, WristPosition.LEVEL));
		ab.addCommand(new DriveToPoint(0.77, 10.5, 140.0, 0.0, 5, 0.75, 7, true, 5000));
		ab.addCommand(new IntakeAntiJamNoBump(1.0, 150));
		ab.addCommand(new IntakeWait());
		ab.addCommand(new DriveToPoint(2.4, 7.75, 90.0, 0.0, 5, 0.75, 7, true, 5000));
		ab.addCommand(new DriveWait());
