...
public class RightSide1FarLeftScale implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveToPoint(-18.3, 4.2, 180, 8, 12, 0.5, 25, true, 5000));
		ab.addCommand(new DriveToPoint(-20.7, 5.89, 128, 6, 10, 0.25, 25, true, 5000));
		ab.addCommand(new DriveToPoint(-22.3, 10.22, 90, 6, 10, 0.25, 25, true, 5000));
		ab.addCommand(new DriveToPoint(-22.1, 27.0, 90, 8, 12, 0.5, 25, true, 5000));
		ab.addCommand(new DriveTurnToAngle(0, 3, 5000));
		...
		ab.addCommand(new DriveToPoint(-19.1, 28.3, 0, 0, 3, 0.1, 25, true, 2000));
		...
		ab.addCommand(new DriveToPoint(-22.3, 28.3, 0, 0, 3.5, 0.5, 25, true, 2000));
		ab.addCommand(new DriveTurnToAngle(45, 3, 5000));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
