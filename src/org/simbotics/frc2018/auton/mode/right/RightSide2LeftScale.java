...
public class RightSide2LeftScale implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveToPoint(1.0, 13.3, 90, 11, 11, 1.0, 5, false, 5000));
		ab.addCommand(new DriveToPoint(-1, 17.3, 135, 11, 11, 1.0, 15, false, 5000));

		// Drive across the field
		ab.addCommand(new DriveToPoint(-17.3, 20.6, 176, 7, 11.0, 1.0, 7, false, 5000));
		...
		ab.addCommand(new DriveToPoint(-16.9, 23.6, 75, 0, 4, 0.5, 2000));
		...
		// go to second cube
		ab.addCommand(new DriveToPoint(-19.5, 21.5, 75, 0.5, 5, 0.25, 5000));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		...
		// back up
		ab.addCommand(new DriveToPoint(-18.5, 21.5, 75, 0.5, 6, 0.25, 5000));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		ab.addCommand(new LiftSetPosition(ElevatorPosition.GROUND, WristPosition.LEVEL, 0.7, true, 3000));
		ab.addCommand(new AutonWait(500));
		ab.addCommand(new IntakeAntiJamNoBump(1.0, 140));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.GROUND, WristPosition.LEVEL, true));
		ab.addCommand(new DriveToPoint(-14.75, 19.2, -30, 0, 4, 0.25, 7, true, 2500));
		ab.addCommand(new DriveWait());
