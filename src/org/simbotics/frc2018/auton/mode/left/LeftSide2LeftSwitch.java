...
public class LeftSide2LeftSwitch implements AutonMode {

	@Override
	public void addToMode(AutonBuilder ab) {
		// go to score first cube
		ab.addCommand(new DriveSetPosition(0, 0, 90));
		ab.addCommand(new DriveToPoint(1.8, 9.2, 180-130, 0, 10, 0.5,25,40,true, 5000));
		...
		// go to second cube
		ab.addCommand(new DriveToPoint(0.0, 21.2, 180-270, 0, 9, 0.5,25,true, 5000));
		...
		ab.addCommand(new DriveTurnToAngle(180-217, 5, 750));
		ab.addCommand(new IntakeAntiJamNoBump(1.0,60));
		ab.addCommand(new DriveToPoint(2.5, 19.5, 180-217, 0, 6, 0.5,25,true, 5000));
		...
		ab.addCommand(new DriveToPoint(2.3, 20.2, 180-230, 0, 6, 0.5,25,true, 5000));
		ab.addCommand(new AutonWait(250));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		ab.addCommand(new LiftSetPosition(ElevatorPosition.GROUND, WristPosition.LEVEL, 20));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.GROUND, WristPosition.LEVEL));
		ab.addCommand(new DriveToPoint(5.88, 18.5, 180-190, 0, 4, 0.5,25,true, 5000));
		...
		ab.addCommand(new LiftSetPosition(ElevatorPosition.SWITCH, WristPosition.LEVEL, 1250));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.SWITCH, WristPosition.LEVEL));
		ab.addCommand(new DriveTurnToAngle(180-270, 5, 1000));
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveTurnToAngle(180-180, 5, 1000));
		ab.addCommand(new DriveWait());
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		ab.addCommand(new LiftSetPosition(ElevatorPosition.GROUND, WristPosition.LEVEL, 20));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.GROUND, WristPosition.LEVEL));
