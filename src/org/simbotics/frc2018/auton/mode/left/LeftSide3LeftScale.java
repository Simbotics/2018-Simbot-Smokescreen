...
public class LeftSide3LeftScale implements AutonMode {

	@Override
	public void addToMode(AutonBuilder ab) {
		ab.addCommand(new DriveSetPosition(0, 0, 90));
		ab.addCommand(new DriveToPoint(0, 19.5, 180-90, 6, 11, 0.25, 25, false, 5000));
		...
		ab.addCommand(new DriveToPoint(0.8, 22.85, 180-110, 0, 6, 0.25, 25,20, true, 5000));
		...
		ab.addCommand(new DriveToPoint(-0.34, 20.44, 180-120, 0, 5, 0.5, 25, true, 4500));
		...
		ab.addCommand(new DriveToPoint(1.4, 19.3, 180-220, 4, 8.5, 0.5, 25, true, 2000));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.GROUND, WristPosition.LEVEL, false));
		ab.addCommand(new DriveToPoint(2.97, 18.25, 180-235, 0, 4, 0.1, 25, true, 3000));
		ab.addCommand(new IntakeWait());
		ab.addCommand(new AutonOverride(RobotComponent.DRIVE));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));

		// go to scale with 2nd cube
		ab.addCommand(new DriveToPoint(-2.0, 22.5, 180-220, 3.5, 9, 0.5, 25, true, 3000));
		...
		ab.addCommand(new DriveToPoint(0.49, 24.5, 180-116, 0, 4.0, 0.5, 25, true, 3000));
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveTurnToAngle(180-126, 1.0, 300));
		ab.addCommand(new DriveToPoint(-1.59, 23.5, 180-126, 0.5, 4.0, 0.5, 25, true, 3000));
		ab.addCommand(new AutonWait(650));
		ab.addCommand(new IntakeSetOutput(0));
		...
		ab.addCommand(new DriveToPoint(4.0, 18.2, 180-225, 3, 12.0, 0.5, 15, true, 3000));
		ab.addCommand(new AutonOverride(RobotComponent.LIFT));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.GROUND, WristPosition.LEVEL, false));
		ab.addCommand(new IntakeWait());
		ab.addCommand(new AutonOverride(RobotComponent.DRIVE));
		...
		ab.addCommand(new IntakeAntiJamClosed());
		ab.addCommand(new DriveToPoint(-1.06, 22.2, 180-225, 3, 12, 0.5, 25, true, 3000));
		ab.addCommand(new AutonWait(750));
		ab.addCommand(new AutonOverride(RobotComponent.INTAKE));
		ab.addCommand(new LiftSetPosition(ElevatorPosition.SCALE_UP, WristPosition.LEVEL, 0.8, false, 5000));
		ab.addCommand(new DriveToPoint(0.5, 23.6, 180-123, 3, 6, 0.5, 25, true, 5000));
		ab.addCommand(new LiftHoldPosition(ElevatorPosition.SCALE_UP, WristPosition.LEVEL, false));
		ab.addCommand(new DriveWait());

		ab.addCommand(new IntakeSetOutput(-1.0));
		ab.addCommand(new DriveTurnToAngle(180-123, 1.0, 500));
		ab.addCommand(new AutonWait(650));
		ab.addCommand(new IntakeSetOutput(0));
