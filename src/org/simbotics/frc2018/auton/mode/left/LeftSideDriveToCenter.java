...
public class LeftSideDriveToCenter implements AutonMode {

	@Override
	public void addToMode(AutonBuilder ab) {
		// Drive past the switch
		ab.addCommand(new DriveSetPosition(0, 0, 90));
		ab.addCommand(new DriveToPoint(0, 18.8, 180-90, 2.5, 11, 1.0, 25, true, 5000));
		...
		ab.addCommand(new DriveToPoint(1, 20.3, 180-135, 3, 7, 1.0, 25, true, 5000));
		// Drive across the field
		ab.addCommand(new DriveToPoint(8.25, 20.6,180- 180, 0, 10.5, 1.0, 25, true, 5000));
		ab.addCommand(new DriveTurnToAngle(180-180, 0.25, 5000));
